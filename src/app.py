...
def list_users():
  ...
  return render_template('users.html', users=users, host_url="https://ancient-crag-90092.herokuapp.com/")

@app.route('/users/test')
def list_users_with_test():
  users = User.query.all()
  return render_template('users.html', users=users, testing=True, host_url="https://ancient-crag-90092.herokuapp.com/")
